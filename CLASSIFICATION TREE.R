...
#Carseats
#names(Carseats)
#sort(Carseats$Price,Carseats decreasing = FALSE)
...
#from the plot, you see a downward spiral part coz of -
...
#class(cv.tree.Carseats)
#class(prune.cv.tree.Carseats)

#Evaluate the test set again
tree.predicted1<-predict(prune.cv.tree.Carseats,Carseats[-trained,],
                         type = "class")
with(Carseats[-trained,],table(tree.predicted1, High))
